          ...
          users.map((user: any) => (
            ...
            >
              ...
              <div className="flex text-center  justify-center">
                <Image src={user.img} alt="user" className="w-32 h-32 rounded-full" width={100} height={100} />
              </div>
              ...
              <div className="flex justify-center text-center items-center gap-1">
                {user.skill_tags.map((skill, index) => (
                  <p className=" bg-green-300 rounded py-1 px-1 text-xs  grid text-gray-700" key={index}>
                    {skill}
                  </p>
                ))}
              </div>
